...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  dark: "cursor-pointer bg-gray-900 text-white hover:bg-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-2",
};
